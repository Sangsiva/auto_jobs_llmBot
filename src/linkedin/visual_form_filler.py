...
class VisualFormFiller:
    ...
    def _build_profile_text(self) -> str:
        ...
        p = self.profile
        pi = p if isinstance(p, dict) else {}

        # Handle both flat profile dict (from personal_information key) and nested YAML
        ...
        lines = [
            ...
            f"Nationality: Singaporean PR / Indian",
            f"Notice Period: Immediately available",
            f"Years of Experience: 10+",
            f"Current Role: AI Data Engineer / Lead Data Engineer at Tookitaki",
            f"Desired Salary: SGD 10,000 - 12,000 per month",
            f"Work Authorization: Singapore PR (no sponsorship needed)",
            f"Education: Bachelor of Engineering - Electrical Engineering, M. Kumarasamy College of Engineering (2013)",
            f"Skills: Spark, Scala, Python, Kafka, LangChain, LangGraph, FastAPI, Kubernetes, EKS, Airflow, SparkML, AWS",
        ]
